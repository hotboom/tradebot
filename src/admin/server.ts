...
function envFromForm(form: URLSearchParams): EnvFormValues {
  return {
    ...
    maxPositions: form.get("maxPositions") ?? "",
    maxPositionsWindowSec: form.get("maxPositionsWindowSec") ?? "",
    ...
    breakevenExtraProfitPercent: form.get("breakevenExtraProfitPercent") ?? "",
