...
// Опрос стакана раз в 500мс — над 10-секундным окном по умолчанию это ~20 замеров, с большим
// запасом по rate limit паблик-эндпоинта (без подписи, лимиты Bybit на него намного выше, чем
// на ордер-эндпоинты). Не выносим в конфиг — низкоуровневая механика, как REPRICE_INTERVAL_MS
// в limitChaseEntry.ts.
